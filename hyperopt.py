...
def compute_scalar_residual(n_max, l_max, atom_width, rad_r0, rad_m,
                            ...
                            n_sparse_envs=2000, print_progress=True):
    ...
    natoms_list = [geom.get_number_of_atoms() for geom in geoms_test]
    resids = compute_residuals(
            scalar_weights, dipoles_test, charges_test, natoms_list,
...
def compute_cv_error(params, n_max, l_max, workdir=None, cv_basename='cv'):
    atom_width, rad_r0, rad_m, dipole_reg, charge_reg = params
    rmse_sum = 0
...
if __name__ == "__main__":
    ...
    result = scipy.optimize.minimize(
        compute_cv_error, [0.5, 3.0, 2.0, 1.0, 100.0],
